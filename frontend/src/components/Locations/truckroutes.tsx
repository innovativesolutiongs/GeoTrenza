...
// Placeholder static markers — route playback will be wired to /api/positions
// in Stage 3c. Tagged STATIONARY so the new marker-state visual works.
const markersData: MarkerType[] = [
    { id: 1, lat: 28.6139, lng: 77.209,  state: "STATIONARY" }, // Delhi
    { id: 2, lat: 19.076,  lng: 72.8777, state: "STATIONARY" }, // Mumbai
    { id: 3, lat: 13.0827, lng: 80.2707, state: "STATIONARY" }, // Chennai
    { id: 4, lat: 22.5726, lng: 88.3639, state: "STATIONARY" }, // Kolkata
    { id: 5, lat: 26.9124, lng: 75.7873, state: "STATIONARY" }, // Jaipur
    { id: 6, lat: 12.9716, lng: 77.5946, state: "STATIONARY" }, // Bangalore
    { id: 7, lat: 17.385,  lng: 78.4867, state: "STATIONARY" }, // Hyderabad
];
